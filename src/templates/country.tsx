...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    title: `${document.c_meta_title?document.c_meta_title:`Royal Cafe Store in ${document.name} | Find a Local Store`}`,
    charset: "UTF-8",
    ...
    tags: [
      {
      ...
      },
        {
          ...
          attributes: {
            name: "description",
            content:`${document.c_meta_description?document.c_meta_description:`Royal Cafe Store Royal Cafe Store ${document.name} and discover the location details you need to visit us today.`}`,
          },
        },
      ...
      //   // /og tags
        ...
        },
        {
          ...
          attributes: {
            ...
            content: `${document.c_meta_description?document.c_meta_description:`Royal Cafe Store in ${document.name}.Royal Cafe Store`}`,
          },
        },
        {
          type: "meta",
...

      {
        ...
        attributes: {
          ...
          content: `${document.c_meta_description?document.c_meta_description:`Royal Cafe Store in ${document.name}. We stock high-quality, robust products at competitive rates.`}`
        },
      },
    ],
  };
